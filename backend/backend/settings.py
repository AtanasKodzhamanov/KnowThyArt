...
DATABASE_URL = os.environ['DATABASE_URL_KNOW_THY_ART']
...
SECRET_KEY = os.environ['DJANGO_SECRET_KEY_KTA']
'django-insecure-_fg!7r$i=-w!49jgivh3eal4aj+anl0k-=dyvgk*k$+y*yz=w-'
